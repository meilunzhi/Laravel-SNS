    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading"><strong>{{ $nickname }}</strong>收藏的帖子
                </div>
                <!-- /.panel-heading -->
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                	...
                                	<a href="{{ url('admin/user/remove-collect',['userId'=>$article->pivot->user_id,'article_id'=>$article->pivot->article_id]) }}" class="btn btn-danger btn-xs">移除</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
